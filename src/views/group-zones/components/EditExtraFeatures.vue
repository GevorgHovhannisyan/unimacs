<template>
  <vs-tabs
    ...
    class="tab-action-btn-fill-conatiner features_tabs"
  >
      ...
      <div class="tab-text mt-3">
        <div class="vx-row w-full w-1/4" style="align-items: center">
          ...
          <div class="vx-col">
            ...
            <v-select
              style="width: 170px"
              v-model="extra_settings.antipass_backs.time_type"
              :options="minuteTypes"
...
export default {
  ...
  watch: {
    ...
    activeZone() {
      ...
      } else if (!zone.apb_reset_timer) {
        zone.apb_reset_timer = {
          enable: false,
          time: null,
          unit: "seconds",
        };
      ...
      } else if (!zone.people_limits_max) {
        zone.people_limits_max = {
          enable: false,
          time: null,
        };
      }
      ...
      } else if (!zone.people_limits_min) {
        zone.people_limits_min = {
          enable: false,
          time: null,
        };
      }
