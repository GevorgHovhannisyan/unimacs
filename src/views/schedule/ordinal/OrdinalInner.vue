  ...
  <div>
      ...
      <div>
        ...
        <div class="vx-row">
          <div class="vx-col md:w-1/3">
            <flat-pickr :config="configdateStartTimePicker" v-model="editData.start" placeholder="Start Time" />
          </div>
          <div class="vx-col md:w-1/3">
            <flat-pickr :config="configdateEndTimePicker" v-model="editData.end" placeholder="End Time" />
          </div>
          <div class="vx-col md:w-1/3">
        ...
        <div class="vx-row w-full">
          <div class="vx-col w-full" style="display: flex; flex-direction: row-reverse">
            <vs-button class="mr-6 mt-4 unimacs_button" @click="updateInfo">Submit</vs-button>
    ...
    <div class="vx-row mb-5">
      <div class="vx-col md:w-2/3">
        <span>Date</span>
        <flat-pickr class="w-full" v-model="editData.name" label="Date" placeholder="Date" />
      </div>
      <div class="vx-col md:w-1/3">
        <vs-button class="w-full mt-5 unimacs_button" @click.prevent="updateScheduleInfo"
          v-if="permissions.updateItem">Submit</vs-button>
      </div>
    </div>
    <div class="vx-row">
...
export default {
  ...
  methods: {
    ...
    confirmAddTime() {
      ...
      if (this.schedules && this.schedules.length < 4) {
        this.$vs.dialog({
          type: "confirm",
          color: "success",
