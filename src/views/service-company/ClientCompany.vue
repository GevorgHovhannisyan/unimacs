<template>
  <div class="data-list-container client_company_page">
    <div class="vx-card p-6">
      <div class="flex flex-wrap items-center">
        <vs-tabs>
          <vs-tab label="Client Company Information">
            <div class="con-tab-ejemplo">
              <div class="vx-row">
                <div class="vx-col md:w-1/6 w-full image_col">
                  <div class="client_company_image">
                ...
                <div class="vx-col md:w-1/2 w-full listing">
                  <h3>Client Company ID: {{ companyInfo.id }}</h3>
                  <h3 class="mt-1 mb-3">
                    Contact Person: {{ contact_person }}
                  </h3>
                  <div class="vx-row w-1/3">
                    <div data-v-b7be2184="" class="vx-col">Email:</div>
                    <div data-v-b7be2184="" class="vx-col">{{ email }}</div>
                  </div>
                  <div class="vx-row w-1/3">
                    <div data-v-b7be2184="" class="vx-col">Phone:</div>
                    <div data-v-b7be2184="" class="vx-col">{{ phone_1 }}</div>
                  </div>
                  <div class="vx-row w-1/3">
                    <div data-v-b7be2184="" class="vx-col">Address:</div>
                    <div data-v-b7be2184="" class="vx-col">{{ address }}</div>
                  </div>
                  <div class="vx-row w-1/3">
                    <div data-v-b7be2184="" class="vx-col">Site:</div>
                    <div data-v-b7be2184="" class="vx-col">{{ site }}</div>
                  </div>
                  <vs-input
                    class="w-full mt-3"
          ...
          <vs-tab label="Company documents" v-if="documentsPermission">
            <div class="con-tab-ejemplo">
              <div class="vx-row">
                <div class="vx-col" v-for="(file, index) in files" :key="index">
                  ...
                  >
                    ...
                    <div>
                      <vs-button
                        type="border"
                        @click="confirmDeleteRecord(file)"
                        color="danger"
                        v-if="file.image"
                        >Remove Document</vs-button
                      >
                    </div>
                  </div>
                </div>
              ...
              <div class="new_images">
                ...
                <vs-button
                  class="mr-4 unimacs_button"
                  v-if="documentsPermission && documentsPermission.saveFile"
                  @click="$refs.update_image.click()"
                  >Upload</vs-button
                >
              </div>
            </div>
            <div class="vx-row">
              <div class="vx-col w-full">
                <div class="mt-8 flex flex-wrap items-center justify-end">
                  <vs-button
                    class="ml-auto mt-2 unimacs_button"
                    v-if="documentsPermission && documentsPermission.updateItem"
...
time: 7000,
  ...
  computed: {
    ...
    documentsPermission() {
      return localStorage.permissions &&
        JSON.parse(localStorage.permissions)["CompanyDocuments"]
        ? JSON.parse(localStorage.permissions)["CompanyDocuments"].actions
        : null;
    },
    // hasServiceRole() {
    //   return localStorage.permissions &&
